...
- [Technology adjacency table](#technology-adjacency-table)

## Score examples by level

Use these as tone and structure calibration. Note how descriptions vary in length with score — higher scores reference more projects; zero scores are one sentence.
...
When the CV shows strong experience with a related technology, use this table for guidance. Always state the adjacency explicitly in the description — never present adjacent experience as direct.

| Requested | Adjacent (score ~5) |
|-----------|-------------------|
| MSSQL | PostgreSQL, MySQL, Oracle, MariaDB |
| Angular | React, Vue, Svelte |
| AWS | Azure, GCP |
| Jenkins | GitHub Actions, GitLab CI, CircleCI |
| OpenShift | Kubernetes, Docker Swarm |
| .NET/C# | Java/Kotlin (similar paradigm) |
| Terraform | Pulumi, CloudFormation, Ansible |
| Kafka | RabbitMQ, ActiveMQ, NATS |
| Spring Boot | Quarkus, Micronaut, Ktor |
| REST API | GraphQL (related but different paradigm) |